 ...
 * @file
 *
 * @brief This file defines the structs for a card,
 * player and a game state.
 */
 ...
 *
 * @note We use a struct instead of a typedef in case
 * it turns out that we need more information later on
...
struct Card {
	 ...
	 *
	 * This is denoted by true if the player can have
	 * the card and false otherwise. To give an example,
	 * [0,1,0] means that player 0 and 2 cannot have
	 * this card, but player 1 can have this card.
	 */
	vector<bool> players;
};
